...
-- Copiando estrutura do banco de dados para restaspnet
CREATE DATABASE IF NOT EXISTS `restaspnet` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `restaspnet`;

-- Copiando estrutura para tabela restaspnet.books
...
-- Copiando dados para a tabela restaspnet.books: ~16 rows (aproximadamente)
DELETE FROM `books`;
...
INSERT INTO `books` (`id`, `Author`, `LaunchDate`, `Price`, `Title`) VALUES
	...
	(16, 'Jeff Suther', '2002-11-29 15:15:13.636000', 60.00, 'Scrum a arte de fazer o dobro do trabalho na metade do tempo');
/*!40000 ALTER TABLE `books` ENABLE KEYS */;

-- Copiando estrutura para tabela restaspnet.changelog
...
-- Copiando dados para a tabela restaspnet.changelog: ~12 rows (aproximadamente)
DELETE FROM `changelog`;
/*!40000 ALTER TABLE `changelog` DISABLE KEYS */;
INSERT INTO `changelog` (`id`, `type`, `version`, `description`, `name`, `checksum`, `installed_by`, `installed_on`, `success`) VALUES
	(1, 0, '1.0.1', 'Create Table Persons', 'V1_0_1__Create_Table_Persons.sql', '5C57601C086E1B99BBB04D07959D0F8D', 'root', '2020-05-10 20:37:05', 0),
	(2, 0, '1.0.1', 'Create Table Persons', 'V1_0_1__Create_Table_Persons.sql', '5C57601C086E1B99BBB04D07959D0F8D', 'root', '2020-05-10 20:37:50', 1),
	(3, 0, '1.0.2', 'Alter Table Persons', 'V1_0_2__Alter_Table_Persons.sql', 'CD743A62C549732597DD40FB2A37EAEA', 'root', '2020-05-10 20:37:50', 1),
	(4, 0, '1.0.3', 'Create table books', 'V1_0_3__Create_table_books.sql', 'F549A23CB0D53684731DC7BCBD1C2CD2', 'root', '2020-05-10 20:37:50', 1),
	(5, 0, '1.0.4', 'Insert data in books', 'V1_0_4__Insert_data_in_books.sql', '176BED6692EB72483D6293F87630A8EE', 'root', '2020-05-10 20:37:50', 1),
	(6, 0, '1.0.5', 'Insert data in persons', 'V1_0_5__Insert_data_in_persons.sql', '9C8C00723D8DE4E5A4AC745F484C1DF2', 'root', '2020-05-10 20:37:50', 1),
	(7, 0, '1.0.6', 'Drop table books', 'V1_0_6__Drop_table_books.sql', '996116D4AC3B9566301DE7B869018E5E', 'root', '2020-05-10 20:37:50', 1),
	(8, 0, '1.0.7', 'Recreate table books', 'V1_0_7__Recreate_table_books.sql', 'A24695A9F3D42357BCC78C08BF2FFD6C', 'root', '2020-05-10 20:37:50', 1),
	(9, 0, '1.0.8', 'Reinsert data in books', 'V1_0_8__Reinsert_data_in_books.sql', '3AA7D3B32D6D452A58B268467172E07E', 'root', '2020-05-10 20:37:50', 1),
	(10, 0, '1.0.9', 'Create table users', 'V1_0_9__Create_table_users.sql', '21A098BE693C455B76FD57CA6ACE1D5F', 'root', '2020-05-10 20:37:50', 1),
	(11, 0, '1.0.10', 'Insert data in users', 'V1_0_10__Insert_data_in_users.sql', 'D5A73E85F99502520B2CA1E89600EF4E', 'root', '2020-05-10 20:37:50', 1),
	(12, 0, '1.0.11', 'Insert data in persons', 'V1_0_11__Insert_data_in_persons.sql', '278532E637A34C97C1AD7B129C9B31CF', 'root', '2020-05-10 20:37:50', 1);
/*!40000 ALTER TABLE `changelog` ENABLE KEYS */;

-- Copiando estrutura para tabela restaspnet.persons
...
-- Copiando dados para a tabela restaspnet.persons: ~302 rows (aproximadamente)
DELETE FROM `persons`;
...
-- Copiando estrutura para tabela restaspnet.users
...
-- Copiando dados para a tabela restaspnet.users: ~2 rows (aproximadamente)
DELETE FROM `users`;
